      ...
      >
        ...
        <div className="space-y-4 py-6">
          <Button
            ...
            className="w-full bg-white hover:bg-gray-50 text-gray-900 hover:text-gray-900 border border-gray-300 font-medium py-6 text-base flex items-center justify-center gap-3"
            variant="outline"
          >
          ...
          <Button
            ...
            className="w-full bg-[#24292e] hover:bg-[#1b1f23] text-white font-medium py-6 text-base flex items-center justify-center gap-3"
          >
