...
@graphs_router.get("", operation_id="list_databases", tags=["mcp_resource"], responses={
...
@graphs_router.get("/{graph_id}/data", operation_id="database_schema", tags=["mcp_resource_template"], responses={
    401: UNAUTHORIZED_RESPONSE
})
@token_required
...
@graphs_router.post("/{graph_id}", operation_id="query_database", tags=["mcp_tool"], responses={
    401: UNAUTHORIZED_RESPONSE
})
@token_required
